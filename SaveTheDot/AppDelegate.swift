...
class AppDelegate: UIResponder, UIApplicationDelegate, SkillzDelegate {
  ...
  func tournamentWillBegin(_ gameParameters: [AnyHashable : Any]!, with matchInfo: SKZMatchInfo!) {
    ...
    viewController?.setupPlayerView()
    viewController?.prepareGame()
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool {
    Skillz.skillzInstance().initWithGameId("6373", for: self, with: SkillzEnvironment.sandbox, allowExit: true)
